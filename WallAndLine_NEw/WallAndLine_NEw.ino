...
void loop() {
    wallsensorRead();
    Serial.println(wallpositionLeft);
    Serial.println(wallpositionRight);
      Serial.print("Line :");
  Serial.println(linefollow);
  Serial.print("wall :");
  Serial.println(wallfollow);
  //delay(1000);
  if (linefollow && !wallfollow){
  if(linefollow){
    sensorRead();
    Serial.print("Line");
  ...
  if(dVal[0] == 1 && dVal[1] == 1 && dVal[2] == 1 && dVal[3] == 1 && dVal[4] == 1 && dVal[5] == 1 && dVal[6] == 1 && dVal[7] == 1 && dVal[8] == 1 && dVal[9] == 1 && dVal[10] == 1 && dVal[11] == 1 && dVal[12] == 1 && dVal[13] == 1 && dVal[14] == 1 && dVal[15] == 1){
    ...
    }else if(wallfollow && !linefollow){
      if (Sensor2<250 && Sensor3>250){
        Serial.print("Left");
        position=wallpositionLeft/1000.0;
      }else if(Sensor2>250 && Sensor3<250){
        Serial.print("Right");
        position=wallpositionRight/1000.0;
      }else if(Sensor2<250 && Sensor3<250){
        position=((wallpositionRight+wallpositionLeft)/1000.0);
        Serial.print("Test");
      }
      PID_control();
